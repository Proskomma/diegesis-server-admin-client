...
export default function HomePage() {
    ...
    return <Container fixed className="whopage">
        ...
        <Typography variant="body1" paragraph="true">Diegesis pulls data from a number of major open-access archives including:</Typography>
        ...
        <Typography variant="body1" paragraph="true">The Diegesis project is led by Mark Howe from <a href="http://mvh.bible" target="_blank" rel="noreferrer">MVH Solutions</a>.</Typography>
        <Footer/>
    </Container>;
